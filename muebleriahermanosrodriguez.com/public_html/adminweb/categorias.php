...
$varProductoCat_Productos = "0";
if (isset($_GET["cat"])) {
  $varProductoCat_Productos = $_GET["cat"];
}
mysql_select_db($database_conexion, $conexion);
$query_Productos = sprintf("SELECT * FROM productos WHERE productos.categoria = %s", GetSQLValueString($varProductoCat_Productos, "int"));
...
<div class="Texto_blanco" id="contenido_inter_nombre">Descripcion del producto</div>
</div>
<!------------------------------------------------------------------------------------ producto ------------------------------------------------------------------------------------------->
<?php do { ?>
  <div id="contenido_inter_producto">
    <div class="Texto" id="contenido_inter_id"><?php echo $row_Productos['id_producto']; ?></div>
    <div id="contenido_inter_foto" align="center"><img src="../productos/<?php echo $row_Productos['foto']; ?>"  width="100%" /></div>
